...
class AudioTheme_ThemeNotice {
	...
	public function __construct( $args = array() ) {
		if ( ! $this->is_audiotheme_active() && is_admin() && current_user_can( 'activate_plugins' ) ) {
			$this->strings = array(
				'notice'     => __( 'The AudioTheme Framework should be installed and activated for this theme to display properly.', 'progeny-mmxiv' ),
				'activate'   => __( 'Activate now', 'progeny-mmxiv' ),
				'learn_more' => __( 'Find out more', 'progeny-mmxiv' ),
				'dismiss'    => __( 'Dismiss', 'progeny-mmxiv' ),
			);
